...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL', 'movieswatch996886@gmail.com')
EMAIL_HOST_PASSWORD = os.getenv('APP_PASSWORD', 'ppqh chns dvhi qgrp')
DEFAULT_FROM_EMAIL = os.getenv('EMAIL', 'movieswatch996886@gmail.com')
SERVER_EMAIL = os.getenv('EMAIL', 'movieswatch996886@gmail.com')
